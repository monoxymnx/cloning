...
import { MstyleData } from "../data/Mstyle";
...
const Mstyle = (props: Props) => {
  ...
  const currentItems = MstyleData.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <Container>
      <Grid container spacing={2} justifyContent="center" alignItems="center">
        <Grid item xs={12}>
          <h2 style={{ textAlign: "start" }}>Mstyle</h2>
        </Grid>
        <Grid
          container
          spacing={2}
        ...
        <Grid item xs={12} style={{ textAlign: "center" }}>
          ...
          >
            <Pagination
              count={Math.ceil(MstyleData.length / itemsPerPage)}
              page={currentPage}
