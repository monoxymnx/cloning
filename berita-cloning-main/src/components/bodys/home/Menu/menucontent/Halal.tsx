...
import { HalalData } from "../data/Halal";
...
const Halal = (props: Props) => {
  ...
  const currentItems = HalalData.slice(indexOfFirstItem, indexOfLastItem);
  ...
  return (
    <Container>
      <Grid container spacing={2} justifyContent="center" alignItems="center">
        <Grid item xs={12}>
          <h2 style={{ textAlign: "start" }}>Halal</h2>
        </Grid>
        <Grid
          container
          spacing={2}
        ...
        <Grid item xs={12} style={{ textAlign: "center" }}>
          ...
          >
            <Pagination
              count={Math.ceil(HalalData.length / itemsPerPage)}
              page={currentPage}
