...
import { travelData } from "../../../../data/berita/travel";
type Props = {};
...
const TravelComponents = (props: Props) => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 13;

  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentItems: TravelItem[] = travelData.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
...
export default TravelComponents;
