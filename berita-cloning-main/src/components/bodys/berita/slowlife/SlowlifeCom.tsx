...
import { slowlifeData } from "../../../../data/berita/slowlife";
type Props = {};
...
const SlowlifeComponents = (props: Props) => {
  const [currentPage, setCurrentPage] = useState(1);
  const itemsPerPage = 13;

  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  const currentItems: SlowlifeItem[] = slowlifeData.slice(
    indexOfFirstItem,
    indexOfLastItem
  );
  ...
  return (
    <div className="main">
      <Container className="container-love">
        ...
        >
          <Pagination
            count={Math.ceil(slowlifeData.length / itemsPerPage)}
            page={currentPage}
...
export default SlowlifeComponents;
